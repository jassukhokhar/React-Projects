...
const RightCardcontent = (props) => {
  return (
     <div className='absolute top-0 left-0 h-full w-full p-7 flex flex-col justify-between'>
        ...
        <div>
          <p className='text-shadow-2xs text-xl leading-relaxed text-white mb-14'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto eum dolore enim inventore totam perferendis.</p>
